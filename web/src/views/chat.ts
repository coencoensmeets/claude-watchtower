...
import { STATE, displaySince, stateKeyOf } from "../sessions/state.js";
import { CHAT_LIMIT_MAX, CHAT_PAGE, app, chat, selected, sidebar } from "../state.js";
import { detailPane } from "../ui/dom.js";
import { clockOf, duration, escapeHtml, shorten } from "../ui/format.js";
...
export const commented = new Map(); // sessionId -> Set of exact passages
