...
/* When the repository was last read, and how often it is worth re-reading. */
let gitPolledAt = 0;
...
export function toggleDiff(path, staged) {
...
export async function gitDo(action, extra, button) {
  const id = app.selectedId;
